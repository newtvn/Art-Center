<template>
  <section class="min-h-screen flex flex-col items-center justify-center px-6 text-center">
    <div class="max-w-4xl pt-20 md:pt-0">
        <p v-reveal class="text-zinc-500 uppercase tracking-[0.5em] text-[10px] mb-6">Established 2026</p>
        ...
        <div class="flex flex-col md:flex-row items-center gap-12 mt-12 md:mt-16 text-left border-t border-zinc-300 pt-12 w-full">
            <p v-reveal="{ delay: 0.2 }" class="md:w-1/2 text-lg md:text-xl text-zinc-600 font-light leading-relaxed">
